...
import static com.globant.vet.util.ConstantsTests.ID_CUSTOMER_2;
import static com.globant.vet.util.ConstantsTests.NAME_CUSTOMER;
import static com.globant.vet.util.ConstantsTests.NAME_CUSTOMER_2;
import static com.globant.vet.util.ConstantsTests.ID_PET_1;
import static com.globant.vet.util.ConstantsTests.ID_PET_2;
import static com.globant.vet.util.ConstantsTests.ID_PET_3;
import static com.globant.vet.util.ConstantsTests.ID_PET_4;
import static com.globant.vet.util.ConstantsTests.ID_CUSTOMER_NOT_FOUND;
...
import static com.globant.vet.util.ConstantsTests.CUSTOMER_NOT_FOUND;
import static com.globant.vet.util.ConstantsTests.CUSTOMER_DELETED;
...
public class CustomerServiceImplTest {
	...
	public void getACustomerWithPetsSuccess() {
		...
		when(validatorUtil.validateExistance(findCustomerByIdPresent, ID_CUSTOMER, CUSTOMER_NOT_FOUND)).thenReturn(customerWithIdAndListPets);
	...
	public void getACustomerWithPetsFailureNotPresent() {
		...
		when(validatorUtil.validateExistance(optionalCustomerNotPresent, ID_CUSTOMER_NOT_FOUND, CUSTOMER_NOT_FOUND)).thenThrow(EntityNotFound.class);
	...
	public void getAllCustomers() {
		...
		CustomerDTO<CustomerInfoWithPets> customerDto2 = new CustomerDTO<CustomerInfoWithPets>(ID_CUSTOMER_2, customer2WithPets);
		
		when(customerRepo.findAll()).thenReturn(customersDb);
		when(customerConverter.customerInfoWithPetsToCustomerDTO(anyInt(), any(CustomerInfoWithPets.class))).thenReturn(customerDto2);
	...
	public void updateCustomerSuccess() {
		...
		when(validatorUtil.validateExistance(optionalCustomerPresent, ID_CUSTOMER, CUSTOMER_NOT_FOUND)).thenReturn(customerFromDb);
	...
	public void updateCustomerFailure() {
		...
		when(validatorUtil.validateExistance(optionalCustomerNoPresent, ID_CUSTOMER_NOT_FOUND, CUSTOMER_NOT_FOUND)).thenThrow(EntityNotFound.class);
